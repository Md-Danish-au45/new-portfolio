        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                ...
                <h4>
                    <FormattedMessage
                        id='description'
                        defaultMessage='My name is Md Danish and I am a full stack developer.'
                    />
                </h4>
                <p>
                    <FormattedMessage
                ...
                <ul>
                    ...
                    <li>
                        <p><span>Email:</span> danishm8560@gmail.com</p>
                    </li>
                    <li>
                        <p>
                            <span>
            ...
            <div className="columns col-skill" data-aos="fade-left" data-aos-delay="650">
                ...
                <div className="skill">
                    ...
                    <div>
                        <img alt="jQuery" className="icons-skils" src={require('../../img/logo-removebg-preview.png')} />
                        <h5>MUI</h5>
                    </div>
                    <div>
                    ...
                    <div>
                        <img alt="Typescript" className="icons-skils" src={require('../../img/python.png')} />
                        <h5>Python</h5>
                    </div>
                </div>
                <h4>Back-End</h4>
                <div className="skill">
                    ...
                    <div>
                        <img alt="php" className="icons-skils" src={require('../../img/django.png')} />
                        <h5>Django</h5>
                    </div>
                </div>
                <h4>
                ...
                <div className="skill">
                    ...
                    <div>
                        <img alt="photoshop" className="icons-skils" src={require('../../img/canvas.png')} title="canvas" />
                        <h5>canvas</h5>
                    </div>
                    <div>
